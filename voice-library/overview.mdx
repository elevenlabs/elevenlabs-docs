...
The Voice Library (VL) is a marketplace where our community can share voices they have created with the rest of the community. These voices are created using either the Voice-Designer tool, which is available on our platform to all users, or they can be created using professional voice cloning. At the moment, we do not allow sharing of voices created using instant voice cloning.
