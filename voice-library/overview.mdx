...
The [Voice Library](https://elevenlabs.io/voice-library) (VL) is a marketplace where our community can share voice models for others to use, including Professional Voice Clones (PVCs) and synthetic voices created using our Voice Design tool. At the moment, Instant Voice Clones (IVCs) cannot be shared.

## How to share a voice model in the Voice Library:
**1. Share Button:** To get started with sharing a voice model, find the voice model you want to share in your Voice Lab and click the share icon in the upper right hand corner:  

<img height="200" src="/voice-library/images/share_voice_start.png" />
...
<img height="200" src="/voice-library/images/share_voice_2.png" />


**3. Sharing Link/Email Whitelist:** Once the ‘Sharing’ toggle is enabled, you have a few ways to share your Voice Model:

<img height="200" src="/voice-library/images/share_voice_3.png" />
...
<img height="200" src="/voice-library/images/share_voice_4.png" />
