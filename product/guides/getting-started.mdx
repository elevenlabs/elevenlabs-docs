---
title: "Overview"
'og:title': "Getting Started | ElevenLabs Docs"
...
<CardGroup cols={2}>
  <Card
    ...
    icon="user-plus"
    href="/product/guides/creating-the-account"
  >
  ...
  <Card
    ...
    icon="page"
    href="/product/guides/landing-page"
  >
  ...
  <Card
    ...
    icon="volume-high"
    href="/product/guides/speech-synthesis"
  >
  ...
  <Card
    ...
    icon="headphones"
    href="/product/guides/sound-effects"
  >
  ...
  <Card
    ...
    href="/product/guides/voiceover-studio"
  >
    Utilize the ultimate tools for voiceover creation and management.
  </Card>
  <Card title="API Guides" icon="code" href="/api-reference">
