...
- **v2.5 Flash**: Generates speech in 32 languages with low latency, ideal for real-time applications.
- **v2 Flash**: Optimized for low-latency English text-to-speech, similar in performance to v2.5 Flash.
