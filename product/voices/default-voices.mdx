...
Unlike voices you add from the Voice Library or new <a href="/product/voices/voice-lab/instant-voice-cloning">Instant Voice Clones (IVCs)</a> or <a href="/product/voices/voice-lab/professional-voice-cloning">Professional Voice Clones (PVCs)</a> you create, default voices are not accessed via your <a href="/product/voices/voice-lab/overview">My Voices</a>.
...
- <b>Voice dropdown menu</b>: Default voices can be selected from the voice
  ...
  <Frame>
    <img
      width="600"
      height="100%"
      src="/product/voices/images/voice-select.webp"
    />
  </Frame>
  ...
  <Frame>
    <img
      width="400"
      height="100%"
      src="/product/voices/images/default-voices.webp"
    />
  </Frame>
