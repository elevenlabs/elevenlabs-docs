...
v2.5 Flash is optimised for low latency and should be used when this is the most important concern, for example, real-time conversational AI.
...
- v2.5 Flash & Turbo v2.5 - up to 40,000 characters (~40 minutes of audio)
- v2 Flash & Turbo v2 - up to 30,000 characters (~30 minutes of audio)
