...
<Accordion title="Text to Speech (Speech Synthesis)">
	...
	- [Full Documentation](/product/speech-synthesis/overview)
	- [API Reference](/api-reference/text-to-speech)
</Accordion>
...
<Accordion title="Speech to Speech (Voice Changer)">
	...
	- [Full Documentation](/product/speech-synthesis/speech-to-speech)
	- [API Reference](/api-reference/speech-to-speech)
</Accordion>
...
<Accordion title="Sound Effects">
	...
	- [Full Documentation](/product/sound-effects/overview)
	- [API Reference](/api-reference/sound-generation)
</Accordion>

<Accordion title="Music (in development)">
	<iframe width="100%" height="400" src="https://www.youtube.com/embed/d8k4Pit4_ZU?si=2zdtx-7zD7S9zGyU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</Accordion>
...
<Accordion title="Voice Design">
	...
	- [Full Documentation](/product/voices/voice-lab/voice-design)
	- [API Reference](/api-reference/ttv-create-previews)
</Accordion>
...
<Accordion title="Instant Voice Cloning">
	...
	- [Full Documentation](/product/voices/voice-lab/instant-voice-cloning)
	- [API Reference](/api-reference/add-voice)
</Accordion>
...
<Accordion title="Professional Voice Cloning">
	...
	- [Full Documentation](/product/voices/voice-lab/professional-voice-cloning)
</Accordion>
...
<Accordion title="Voice Library">
	...
	- [Full Documentation](/product/voices/voice-library/overview)
	- [API Reference](/api-reference/query-library)
</Accordion>
...
<Accordion title="Projects">
	...
	- [Full Documentation](/product/projects/overview)
	- [API Reference](/api-reference/add-project)
</Accordion>
...
<Accordion title="Dubbing">
	...
	- [Full Documentation](/product/dubbing/overview)
	<Accordion title="Automatic">
		...
		- [Full Documentation](/api-reference/create-dub)
		- [API Reference](/api-reference/create-dub)
	</Accordion>
	...
	- [Full Documentation](/product/dubbing/studio)
	</Accordion>
</Accordion>
...
<Accordion title="Voiceover Studio">
	...
	- [Full Documentation](/product/voiceover-studio/overview)
</Accordion>
...
<Accordion title="Audio Native">
	...
	- [Full Documentation](/product/audio-native/overview)
	- [API Reference](/api-reference/creates-audionative-enabled-project)
</Accordion>
...
<Accordion title="Conversational AI">
	...
	- [Full Documentation](/product/conversational-ai/overview)
	- [API Reference](/api-reference/conversational-ai)
</Accordion>
