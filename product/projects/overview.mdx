...
Click “Create new project” and you will be presented with a popup. Here, you can choose to create a new empty project, import an already existing EPUB, PDF, or TXT file, which will then automatically be converted into a project, or import text directly from a website using the URL to have the page be converted into a project. You can then use our [Audio Native](/product/audio-native/overview) feature to easily and effortlessly embed any narration project onto your website.
...
<img height="200" src="/product/projects/images/projects_settings.png" />
