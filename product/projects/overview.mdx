---
title: "Overview"
'og:title': "Projects Overview | ElevenLabs Docs"
...
<Accordion title="How to enable in Convert dialog">
  <Frame>
    <img height="200" src="/product/projects/images/projects_convert_auto_regenerate.webp" />
  </Frame>
</Accordion>

<Accordion title="How to enable in Project settings">
  <Frame>
    <img height="200" src="/product/projects/images/projects_settings_auto_regenerate.webp" />
  </Frame>
</Accordion>
...
- Phonemes. Phonemes are used to specify pronunciation using either the IPA (International Phonetic Alphabet) or CMU Arpabet alphabet. Phoneme rules are currently only supported by the Turbo v2 & v2 Flash English models.
