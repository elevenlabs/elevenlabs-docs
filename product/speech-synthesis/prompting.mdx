...
<u>This feature is currently only supported by the "Eleven English V1", "Eleven v2 Flash" & "Eleven Turbo V2" models</u>.
...
Alternatively, the AI can sometimes infer the intended emotion from the text's context alone, which doesn't require any trimming:
