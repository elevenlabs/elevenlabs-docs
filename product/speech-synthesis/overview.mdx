  ...
  <Tab title="Voice Selection">
    <Frame caption="Voice Selection Dropdown">
        <img
            width="400"
            height="100%"
            src="/product/speech-synthesis/images/tts_voices.png"
        />
    </Frame>
  ...
  <Tab title="Model Selection">
    <Frame caption="Model Selection">
        <img
            width="400"
            height="100%"
            src="/product/speech-synthesis/images/tts_models.png"
        />
    </Frame>
  ...
  <Tab title="Voice Settings">
    <Frame caption="Voice Selection">
        <img
            width="400"
            height="100%"
            src="/product/speech-synthesis/images/tts_settings.png"
        />
    </Frame>
...
<AccordionGroup>
    ...
    <Accordion title="Nondeterministic">
        The AI is nondeterministic, meaning that the same initial conditions (voice, settings, model) can lead to different outcomes. Therefore, each time you press generate, even with the same settings, the results may differ.

        This variability can be due to various factors, and the breadth of that variability can be controlled by the stability slider. A lower stability setting means a wider range of variability between generations, but it also introduces inter-generational variability, where the AI can be a bit more performative with a lower stability.

        This variability can sometimes be desirable, while setting the stability too high will make the AI a bit more monotone, as it does not have the same leeway to generate more variable content. However, it can also introduce other issues if the stability is too low.
    </Accordion>
