...
<img height="150" src="/product/workspace/images/identity_providers.png" />
...
<img height="150" src="/product/workspace/images/verify_domain_button.png" />

- Enter the domain name you want to verify.

<img height="150" src="/product/workspace/images/domain_verification.png" />
...
<img height="150" src="/product/workspace/images/dns_records.png" />
...
- Add the information of required fields (Client Id, Issuer URL, etc.) to ElevenLabs SSO provider form.
  <img height="150" src="/product/workspace/images/sso_oidc.png" />
- Click on `Add Domain` Button and choose the domain you want to enable SSO for from the list of verified domains.
  <img height="50" src="/product/workspace/images/add_domains.png" />
...
- Add the information of required fields (IdP Entity Id, IdP Sign-In URL, etc.) to the ElevenLabs SSO form.
  <img height="150" src="/product/workspace/images/sso_saml.png" />
- Click on `Add Domain` Button and choose the domain you want to enable SSO for from the list of verified domains.
- Click on the `Update SSO` button.
