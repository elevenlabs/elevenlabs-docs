...
If you want to generate multiple clips at once, you can use shift + click to select multiple clips for a speaker at oncec, then right click on one of them to select Generate Audio Fixed Duration for all selected clips.  
