...
The Voice Design feature allows users to select gender, age, and accent to generate unique voices. Keep in mind that it may take a few tries to find the perfect fit. Keep in mind that each time you press generate a small amount of characters is deducted from your account to do the initial creation.
