...
The Voice Design feature allows users to select gender, age, and accent to generate unique voices. Keep in mind that it may take a few tries to find the perfect fit. Keep in mind that each time you press generate (I'm not sure what is supposed to be said here but the sentence just ends half way through).
