...
Since the custom models require fine-tuning and training, it will take some time before you can use your voice clone. We usually estimate ~2 hours but it may take longer depending on the number of users in the queue. You'll be notified via email & in product as soon as your PVC is ready. 
