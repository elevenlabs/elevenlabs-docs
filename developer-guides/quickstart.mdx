...
The ElevenLabs API provides a simple interface to state-of-the-art audio [models](/developer-guides/models) and [features](/api-reference/overview). Follow this guide to learn how to create lifelike speech, generate and modify voices, produce immersive sound effects, isolate background noise from audio, and seamlessly dub audio/videos.
...
With your ElevenLabs API key exported as an environment variable, you're ready to make your first API request. You can either use the [REST API](/api-reference/overview) directly with the HTTP client of your choice, or use one of our official SDKs as shown below.
