...
---
  ...
  <img
    width="400"
    height="100%"
    src="/guides/images/account-creation.png"
  />

<img height="200" src="./images/voice-lab.png" />

The Voices feature allows you to manage and create voices, both private to you and the ones made publicly available by our Community (via the Library).
...
1. **Voice Design Voices** - Randomly computer-generated voices. More information available [here](/voices/voice-lab/voice-design).
...
<Note> With every Voice Clone, it is important that you have the person’s permission to clone their voice.</Note> 
   - Please ensure the audio is recorded without any background sounds, ideally with good equipment and with the tonality, cadence, and performance style you would like to recreate with your generations. Sub-par audio quality will influence the outputs of your generations. For optimal results, we highly recommend following our [guide to Audio Recording](/voices/pvc-step-by-step-guide#beginners-guide-to-audio-recording). 
   - If background noises cannot be avoided, you can use [Voice Isolator](https://elevenlabs.io/blog/voice-isolator) to retrieve the voice and rid yourself of unwanted background noise.
3. Once you’re done generating or creating your voice, it will be made available to you and you alone in the **My Voices** section.
