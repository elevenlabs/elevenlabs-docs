...
1. **Voice Design Voices** - Randomly computer-generated voices. More information available [here](/documentation/voices/voice-lab/voice-design).
...
<Note> With every Voice Clone, it is important that you have the person’s permission to clone their voice.</Note> 
   - Please ensure the audio is recorded without any background sounds, ideally with good equipment and with the tonality, cadence, and performance style you would like to recreate with your generations. Sub-par audio quality will influence the outputs of your generations. For optimal results, we highly recommend following our [guide to Audio Recording](/documentation/voices/pvc-step-by-step-guide#beginners-guide-to-audio-recording). 
