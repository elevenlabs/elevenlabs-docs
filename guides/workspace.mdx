...
<Note>**Important**: you are currently only able to invite users that do not have an ElevenLabs account already, please reach out to success@elevenlabs.io if you are attempting to add someone with an account</Note>
...
<img height="200" src="/guides/images/workspaces.png" />

For more details, visit the [Workspace Overview page](/documentation/workspace/overview).
