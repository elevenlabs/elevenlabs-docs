...
More detailed information about the models is available [here](documentation/speech-synthesis/models).
...
More detailed information about the voice settings is available [here](documentation/speech-synthesis/voice-settings).
...
<Frame>
    <img height="200" src="/guides/images/text-to-speech.png" />
</Frame>
...
<Frame>
    <img height="200" src="/guides/images/speech-to-speech.png" />
</Frame>

<Tip>Speech to Speech is great for getting the right emotion across when the Text to Speech can’t get it right.</Tip>
