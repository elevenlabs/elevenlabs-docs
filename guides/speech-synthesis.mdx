...
More detailed information about the models is available [here](speech-synthesis/models).
...
More detailed information about the voice settings is available [here](speech-synthesis/voice-settings).
...
<Note>Speech to Speech is great for getting the right emotion across when the Text to Speech can’t get it right.</Note>
