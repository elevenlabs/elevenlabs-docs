...
<Frame>
  <img width="500" src="/conversational-ai/images/configuration-1.webp" />
</Frame>
...
<Tabs>
  <Tab title="Javascript">
    ...
    <Step title="Enable overrides">
      ...
      <Frame>
        <img src="/conversational-ai/images/overrides.webp" />
      </Frame>
    </Step>
    <Step title="Start the session with custom overrides">
      ```javascript
