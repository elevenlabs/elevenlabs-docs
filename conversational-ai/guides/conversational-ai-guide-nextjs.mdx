---
title: "Next.JS"
description: "Learn how to create a web application that enables voice conversations with ElevenLabs AI agents"
icon: "react"
---
...
<Frame>
  ![Convai Example Project](/conversational-ai/images/convai-nextjs-example.png)
</Frame>
...
<Steps>
    ...
    <Step title="Test the setup">
        ...
        <Frame>
            ![Verce Default Screen](/conversational-ai/images/convai-nextjs-1.png)
        </Frame>
...
<Warning>
  Signed URLs expire after a short period. In a production environment, you
  should implement proper error handling and URL refresh logic.
</Warning>
