...
<iframe width="100%" height="400" src="https://www.youtube.com/embed/JGjCa1EDHUc" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
(2) Interact with your agent through our [SDK](https://elevenlabs.io/docs/conversational-ai/client-sdk) and build your own custom interface.
