...
<Card title="WebSocket API Documentation" icon="rectangle-terminal" horizontal = "true"  href="/api-reference/conversational-ai">
</Card>
...
(2) Interact with your agent through our [SDK](/conversational-ai-sdks/client-sdk) and build your own custom interface.