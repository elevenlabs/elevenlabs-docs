...
| conversation_initiation_client_data | Override conversation configuration at start |
##### Message Formats
...
```json
{
  ...
  "conversation_config_override": {
      "agent": {
          "prompt": {
              "prompt": "Example prompt override, this will override the agent prompt."
          },
          "first_message": "Example first message override, this will override the agent first message.",
          "language": "en",
      },
      "tts": {
          "voice_id": "Example voice id override, this will override the agent voice id."
      },
  },
  "custom_llm_extra_body": {},
}
