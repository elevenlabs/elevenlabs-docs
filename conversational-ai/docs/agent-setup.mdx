...
To access your assistant from outside ElevenLabs, you need to publish it.
Navigate to the **Publish** section in your assistant's settings and click **Publish**.
...
<Tip>
  You can learn more about this process in the [Publishing](/conversational-ai/docs/publishing) guide.
</Tip>
