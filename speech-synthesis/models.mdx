...
Our most advanced speech synthesis model, Multilingual v2 offers high stability, diverse language support, and exceptional accuracy in 32 languages. While slower than the Turbo models, it delivers more lifelike speech, making it ideal for content creation such as voiceovers, audiobooks, and post-production.

**Important notes**: The accuracy of this model depends heavily on the quality of the input samples. Lower-quality samples can introduce errors, which the AI might attempt to replicate. For best results, use high-quality, consistent voice samples, especially when trying to preserve accents or tonal details across languages.
- Best quality
