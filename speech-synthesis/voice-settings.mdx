...
description: 'A guide on using stability, similarity sliders for tailored voice performances in ElevenLabs. Learn how to strike a balance between emotive and consistent audio outputs.'
---
...
## Controlling pace of the generated audio

While we are working on adding settings for explicitly controlling the voice speed of the generated audio, more reference to this can be found [here](https://help.elevenlabs.io/hc/en-us/articles/13416271012497-Can-I-slow-down-the-pace-of-the-voice-), you can currently use the available `stability` and `similarity` sliders to achieve a similar effect. Play around with them to find the right balance for your use case.
You can also refer to our [prompting](/speech-synthesis/prompting) guide to better understand how to give prompts using punctuations and pauses to control the pace of the generated audio.
