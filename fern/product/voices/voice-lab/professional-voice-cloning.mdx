...
Thirdly, make sure you have enough material to clone the voice properly. You can create a high-quality clone with just 30 minutes of audio, but for optimal results and the most accurate clone we recommend 2+ hours of audio. You might be able to get away with less, but at that point, we can’t vouch for the quality of the resulting clone.
