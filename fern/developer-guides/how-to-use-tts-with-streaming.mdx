...
slug: developer-guides/how-to-use-tts-with-streaming
---
...
def text_to_speech_file(text: str) -> str:
    ...
    response = client.text_to_speech.convert(
        ...
        text=text,
        model_id="eleven_flash_v2_5", # use the flash model for lowest latency
...
<Frame caption="AWS Console Login">
  <img src="../api-reference/images/aws_console_login.webp" />
</Frame>
...
<Frame caption="AWS IAM Dashboard">
  <img src="../api-reference/images/aws_iam_dashboard.webp" />
</Frame>
...
<Frame caption="Add AWS IAM User">
  <img src="../api-reference/images/aws_iam_add_user.webp" />
</Frame>
...
<Frame caption="Set Permission for AWS IAM User">
  <img src="../api-reference/images/aws_iam_set_permission.webp" />
</Frame>
...
<Frame caption="AWS Access Secret Key">
  <img src="../api-reference/images/aws_access_secret_key.webp" />
</Frame>

6. Get AWS region name: ex. us-east-1

<Frame caption="AWS Region Name">
  <img src="../api-reference/images/aws_region_name.webp" />
</Frame>
...
<Frame caption="Enter a New S3 Bucket Name">
  <img src="../api-reference/images/aws_s3_enter_bucket_name.webp" />
</Frame>

<Frame caption="S3 Bucket List">
  <img src="../api-reference/images/aws_s3_bucket_list.webp" />
</Frame>
