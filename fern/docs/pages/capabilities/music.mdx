...
<Tip>
  The Eleven Music API is coming soon. Please [reach out](https://elevenlabs.io/eleven-music-api-request) to request early access.
</Tip>
...
<CardGroup cols={1}>
  ...
  {/* <Card
    ...
    href="/docs/product-guides/playground/eleven-music"
  >
