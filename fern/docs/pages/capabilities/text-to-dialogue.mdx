...
<Warning>
  This feature is currently in alpha and is subject to change.
</Warning>
...
<elevenlabs-audio-player
    ...
    audio-src="/assets/audio/dialogue.mp3"
/>
...
### Emotional deliveries with non-speech audio event
...
You can also use punctuation to indicate the flow of a dialog, for example:

- "Hello, is this seat-"
- "Free? Yes it is."

- "I understand, and I apologize if I upset you. I'll make sure to..."
- "You did. You're annoying."

<Dialogue dialogue={[
  { speaker: 'Alex', text: 'Hello, is this seat-'},
  { speaker: 'Bob', text: 'Free? Yes it is.'},
  { speaker: 'Alex', text: 'I understand, and I apologize if I upset you. I\'ll make sure to...'},
  { speaker: 'Bob', text: 'You did. You\'re annoying.'},
]} />

## FAQ

<AccordionGroup>
  <Accordion title="Can I use any model?">
