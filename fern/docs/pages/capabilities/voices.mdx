...
<Note>
  Voice design with v3 is currently in alpha. You can only remix voices that were created by you,
  for example previously designed voices, IVC and PVC voices.
</Note>
