...
ElevenLabs provides models for voice creation & customization. The platform supports a wide range of voice options, including voices from our extensive [voice library](/docs/voice-library), voice cloning, and artificially designed voices using text prompts.

### Voice categories

- **Community**: Voices shared by the community from the ElevenLabs [voice library](/docs/voice-library).
- **Cloned**: Custom voices created using [instant](/docs/voice-cloning/instant) or [professional](/docs/voice-cloning/professional) voice cloning.
- **Voice design**: Artificially designed voices created with the [voice design](/docs/voice-design) tool.
- **Default**: Pre-designed, high-quality voices optimized for general use.

#### Community

The [voice library](/docs/voice-library) contains over 5,000 voices shared by the ElevenLabs community. Use it to:
