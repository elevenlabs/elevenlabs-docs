...
<Info>Speech to text is currently in alpha and might not function as expected. A full launch is planned soon.</Info>
...
<AccordionGroup>
  ...
  <Accordion title="Which audio and video formats are supported?">
    All major audio and video formats are supported. For a complete list see the ffmpeg supported [audio](https://www.ffmpeg.org/general.html#Audio-Codecs) and [video](https://www.ffmpeg.org/general.html#Video-Codecs) codecs.
  </Accordion>
  <Accordion title="When will you support more languages?">
    ElevenLabs is constantly expanding the number of languages supported by our models. If you
    have a specific language in mind, please [contact us](https://elevenlabs.io/contact) and we
