...
For example, a 30 minute audio file will be transcribed with a concurrency of 4, while a 120 minute audio file will be transcribed with a concurrency of 15.
