...
<AccordionGroup>
  ...
  <Accordion title="What qualifies as a free regeneration?">
    ...
    Free regenerations are useful in case there is a slight distortion in the audio output. According to our internal benchmarks, free regenerations will solve roughly half of issues with quality, with remaining issues usually due to poor training data.
