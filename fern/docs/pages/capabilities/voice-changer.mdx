...
Our speech-to-speech v2 model supports 29 languages:

<Markdown src="/snippets/v2-supported-languages.mdx" />
...
<Accordion title="Does the AI reproduce background noise?">
