...
For free, Starter and Creator subscriptions the quality will be High (192 kbps MP3, or WAV generated from 192 kbps source).

For Pro, Scale, Business and Enterprise plans, the quality will be Ultra Lossless (16-bit, 44.1 kHz WAV, or 192 kbps MP3).
...
<Accordion title="Generation history">
  ...
  version that is used in your project. 
  
  You can also remove generations, but be aware that if you remove a version, this is permanent and you can't restore it.
</Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Quality setting">
    ...
    - Free, Starter and Creator: High quality - 192 kbps MP3, or WAV converted from 192 kbps source.
    - Pro, Scale, Business and Enterprise plans: Ultra Lossless - 16-bit, 44.1 kHz WAV, or 192 kbps MP3.
