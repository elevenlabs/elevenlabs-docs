...
<AccordionGroup>
  ...
  <Accordion title="Create a podcast">
    ...
    <Note>
      This option will generate a new script based on the document you upload. If you want to generate a podcast using a script you have written and don't want changed, you should use either **Create an audiobook** or **Start from Scratch**. 
    </Note>
...
<Accordion title="Chapters sidebar">
  #### Chapters sidebar
  When you create a Studio project using the **Create an audiobook** option and import a document that includes chapters, chapters will be automatically enabled for your project, and you can toggle the visibility of the Chapters sidebar by clicking **Chapters**. 

  <Frame background="subtle">
    ![Chapters sidebar](/assets/images/product-guides/studio/studio-chapters.webp)
  </Frame>
  
  If you want to add a new chapter, you can do this using the **+** button at the top of the Chapters sidebar.
...
<Accordion title="Generation history">
  ...
  <Frame background="subtle">
    ![Generation History button](/assets/images/product-guides/studio/studio-generation-history-btn.webp)
  </Frame>
...
{' '}
  ...
  The Voices sidebar is where you will find the voices used in your project, along with the voice settings. You can toggle the visibility of the Voices sidebar by clicking **Voices**.
  For more information on voices and voice settings, see the **Settings** section below. 
  </Accordion>
