...
button to generate audio for the entire chapter or project in one step. It will automatically
generate and download an audio file, but you can still edit your project after this. Once you've
finished editing, you will need to use the **Export** button again to generate and download a new
...
<Accordion title="Play">
  ...
  There are two possible modes when using the **Play** button. **Until end** will play existing audio, 
...
<Accordion title="Generate/Regenerate">
  ...
  text, or will generate new audio if you have already generated audio. This will cost credits. If
  you have made changes to the paragraph such as changing the text or the voice, then the paragraph
  will lose its converted status, and will need to be generated again. If the button says
  **Regenerate**, then this means that you're eligible for a free regeneration. You're eligible for
  two free regenerations provided you don't change the voice or the text.
</Accordion>
...
<Accordion title="Generation History">
  ...
  If you prefer an earlier version of the paragraph, you can restore it, and it will then become the
  version that is used in your project. You can also remove generations, but be aware that if you
...
<Accordion title="Multi selecting paragraphs">
  #### Multi selecting paragraphs You can use Ctrl + Click (on PC) or Command + Click (on Mac) to
  select multiple paragraphs at once. This allows you to more easily assign voices to multiple
...
<Accordion title="Lock Paragraph">
  #### Lock Paragraph
  <Frame background="subtle">
      ![Lock Paragrah Button](/assets/images/product-guides/studio/studio-lock.webp)
  </Frame>
  ...
  Locked paragraphs are indicated by a lock icon to the left of the paragraph. If you want to unlock a paragraph, you can do this by clicking the **Lock paragraph** button again.
</Accordion>
</AccordionGroup>
