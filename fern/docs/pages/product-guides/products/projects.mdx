...
Projects is an end-to-end workflow for creating long-form content. With this tool you can upload an entire book, document or webpage and generate a voiceover narration for it. The result can then be downloaded as a single MP3 file or as individual MP3 files for each chapter.

## Guide

<Frame background="subtle">
  ![Projects create](/assets/images/product-guides/projects/projects-home.png)
</Frame>

<Steps>
  <Step title="Create a new project">
    Select one of the start options at the top of the Projects page.
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="Voice settings">
    ...
    <Frame background="subtle">
      ![Projects voice settings](/assets/images/product-guides/projects/projects-voice-settings.png)
    </Frame>
...
<AccordionGroup>
  <Accordion title="Free regenerations">
    <Frame background="subtle">
      ![Projects free regenerations](/assets/images/product-guides/regenerations/regenerations-projects.png)
    </Frame>
