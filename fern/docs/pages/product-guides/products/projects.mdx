...
<img
  src="/assets/images/product-guides/projects/projects-product-feature.png"
  alt="Projects product feature"
...
<Frame background="subtle">
  ![Projects home](/assets/images/product-guides/projects/projects-home.png)
</Frame>

Select one of the start options and you will be presented with a popup. Here, you can choose to create a new empty project, import an already existing EPUB, PDF, TXT or HTML file, which will then automatically be converted into a project, or import text directly from a website using the URL to have the page be converted into a project.

<Note>
  You can then use our [Audio Native](/docs/product/audio-native/overview) feature to easily and
  effortlessly embed any narration project onto your website.
</Note>

## Create a new project

Let's create a new project, so click on **Start from scratch**. You can name your project and choose the default voice. Additionally, you will need to select the model that will be used and decide the quality settings. The voice and its settings can be changed after the project is created.

<Frame background="subtle">
  ![Projects create](/assets/images/product-guides/projects/projects-scratch.png)
</Frame>
...
<Frame background="subtle">
  ![Projects editor](/assets/images/product-guides/projects/projects-labelled-editor.png)
</Frame>

<Accordion title="Learn more about the editor">
...
**13. Current paragraph** current paragraph is indicated by the highlight. Different colours indicate different speakers.
...
<Step title="Add and manage content">
  <>
...
<Step title="Adjust settings and regenerate audio">
<>
...
- Click the "Convert" button to compile and download the entire project or specific chapters as a single audio
  file.
- Use the "Download" button for various download options, including project-wide or
  chapter-specific files.

</>
</Step>

<Step title="Pronunciation dictionaries">
<>

- Upload a pronunciation dictionary in PLS (Pronunciation Lexicon Specification) format via
  project settings.
- Use phonemes or aliases to specify accurate pronunciations of words, ensuring
  consistency and clarity in the generated speech.
...
<Success>
  Upload [_Alice's Adventures in Wonderland by Lewis Carroll_](https://www.gutenberg.org/ebooks/11)
  and convert a chapter of your choosing using the voice of your choosing. Download said chapter.
</Success>
...
<Frame background="subtle">
  ![Projects free
  regenerations](/assets/images/product-guides/regenerations/regenerations-projects.png)
</Frame>
