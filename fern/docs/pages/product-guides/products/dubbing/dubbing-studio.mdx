...
- Underneath is the timeline, which shows the different voices the AI extracted on individual tracks as well as clips indicating when a specific voice is speaking, along with the corresponding clips for the original audio.
