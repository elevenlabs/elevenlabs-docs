...
<AccordionGroup>
  ...
  <Accordion title="Can ElevenLabs help me with my subtitles?">
    Yes – our Productions team can handle subtitles for you end-to-end, including:
    - Ensuring your subtitles adhere to all formatting rules and requirements
    - Translating your subtitles into different languages
