...
<AccordionGroup>
  ...
  <Accordion title="Editing Lyrics and Prompts">
    ...
    To change the lyrics or instrumental prompts of any existing
  ...
  <Accordion title="Style Control">
    #### Style Control 
    For advanced control over specific musical elements: - Hover over the section
  ...
  <Accordion title="Direct Prompting">
    #### Direct Prompting 
    Use the conversation interface at the bottom of the editor to make specific
...
<AccordionGroup>
  <Accordion title="Be Specific with Genre and Style">
    ...
    Instead of generic terms like "rock music," try detailed
  ...
  <Accordion title="Layer Multiple Descriptors">
    ...
    Combine mood, instrumentation, tempo, and use case for better
  ...
  <Accordion title="Define Instrumentation">
    ...
    Call out specific instruments you want to hear: - "Upbeat funk track
  ...
  <Accordion title="Use Include/Exclude Styles">
    ...
    Refine your output by explicitly including or excluding certain
...
<AccordionGroup>
  ...
  <Accordion title="Quality Settings">
    #### Quality Settings Export quality varies by subscription tier: 
