...
<Frame background="subtle">
  ![SSO saml](/assets/images/product-guides/workspaces/workspace-sso-saml.png)
</Frame>

<Frame background="subtle">
  ![SSO provider](/assets/images/product-guides/workspaces/workspace-sso-provider.png)
</Frame>

<Frame background="subtle">
  ![SSO domain
  verification](/assets/images/product-guides/workspaces/workspace-sso-domain-verification.png)
</Frame>
