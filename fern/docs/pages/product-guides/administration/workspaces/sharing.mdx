...
When you create a resource, as the owner of the resource, you have admin permissions on it and this cannot be removed by other admins. 
Other resource admins will be able to remove anyone else from the resource, including other admins.
