...
<AccordionGroup>
  ...
  <Accordion title="How do I add a team member to a Workspace?">
    ...
    Enterprise customers can enable automatic enrollment of users from domains which they have verified following the [Verify Domain step](/docs/product-guides/administration/workspaces/sso#verify-your-email-domain) from the SSO configuration process.
