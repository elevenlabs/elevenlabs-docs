...
<AccordionGroup>
  ...
  <Accordion title="Who is the workspace owner?">
    ...
    Each workspace can have one owner. By default, this will be the account owner for Scale and Business subscriptions. If you downgrade your subscription and exceed the available number of seats on your new plan, all accounts apart from the owner will be locked out. Ownership can be transferred to another account.
