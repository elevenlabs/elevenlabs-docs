...
subtitle: 'A guide for integrating Audio Native into your Squarespace websites'
---
...
<Steps>
    <Step title="Add HTML to your blog post">
        Navigate to your Squarespace blog, sign in and open page you wish to narrate.
    </Step>
    <Step title="Add the embed code to your blog post">
        ...
        <img
            src="/assets/images/product-guides/audio-native/audio-native-squarespace-1.webp"
            alt="Audio Native"
        ...
        <img
            src="/assets/images/product-guides/audio-native/audio-native-squarespace-2.webp"
            alt="Audio Native"
            className="w-full rounded-lg"
        />
    </Step>
    ...
    <Step title="Navigate to the live version of the blog post">
        ...
        <img
            src="/assets/images/product-guides/audio-native/audio-native-squarespace-3.webp"
            alt="Audio Native"
            className="w-full rounded-lg"
        />
    </Step>
