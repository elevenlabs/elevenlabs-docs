...
subtitle: 'A guide for integrating Audio Native into your React projects'
---
...
This guide will show how to integrate Audio Native into React projects. The focus will be on a Next.js project, but the underlying concepts will work for any React ecosystem.

The end result will be a Audio Native player that can narrate the content of a page:
...
<Steps>
  <Step title="Create a Audio Native React component">
