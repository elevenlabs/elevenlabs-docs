...
<Steps>
  <Step title="Navigate to Audio Native">
    In the ElevenLabs dashboard, navigate to "Audio Native" under the "Audio Tools" section.
  </Step>
  <Step title="Configure player appearance">
    Customize the player apperance by selecting a background color and text color.
  </Step>
  <Step title="Configure allowlisted sites">
...
<CardGroup cols={3}>
  <a href="/docs/product-guides/audio-tools/audio-native/react"><Card title="React" icon="brands react" /></a>
  <a href="/docs/product-guides/audio-tools/audio-native/ghost"><Card title="Ghost" icon="duotone ghost" /></a>
  <a href="/docs/product-guides/audio-tools/audio-native/squarespace"><Card title="Squarespace" icon="brands squarespace" /></a>
  <a href="/docs/product-guides/audio-tools/audio-native/framer"><Card title="Framer" icon="duotone browser" /></a>
  <a href="/docs/product-guides/audio-tools/audio-native/webflow"><Card title="Webflow" icon="brands webflow" /></a>
  <a href="/docs/product-guides/audio-tools/audio-native/wordpress"><Card title="Wordpress" icon="brands wordpress" /></a>
  <a href="/docs/product-guides/audio-tools/audio-native/wix"><Card title="Wix" icon="brands wix" /></a>
  <a href="/docs/product-guides/audio-tools/audio-native/substack"><Card title="Substack" icon="duotone page" /></a>
</CardGroup>
