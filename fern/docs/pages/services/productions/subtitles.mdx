...
- **Captions** transcribe all spoken dialogue and include descriptions of relevant non-speech sounds (e.g., [door slams], [dramatic music]). They are typically not translated from the original language.
