...
- **Captions** transcribe all spoken dialogue. They are typically not translated from the original language.
...
<Info>
  SDH (Subtitles for the Deaf and Hard of Hearing) provide dialogue plus essential non-speech audio
  cues (e.g., [door slams], ♪ music ♪) and speaker identification for accessibility. SDH is included
  by default for captions and can be added upon request for subtitles.
</Info>
