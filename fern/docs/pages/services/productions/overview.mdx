...
Productions is a new service that lets you order human-edited transcripts, subtitles, dubs, and audiobooks directly on the ElevenLabs platform. A team of expert linguists and localization professionals vetted and trained by ElevenLabs works on your content and delivers you polished final assets.
...
<CardGroup cols={2}>
  <Card
    ...
    href="/docs/services/productions/transcripts.mdx"
  >
    Reviewed by native speakers for maximum accuracy
  </Card>
  <Card title="Subtitles (coming soon)" icon="duotone subtitles">
...
<Steps>
    <Step title="Upload new files or select existing files">
        ...
        **Starting from an existing asset**: you can also order human-edited versions of existing assets in your ElevenLabs account. Look for the 'Get human review' button in the top right of our editors for this option.
        <Frame background="subtle">
    ...
    <Step title="Review and confirm quote">
        ...
        When you click 'Continue,' we will quickly check the files you uploaded and return the final price to you.

        <Frame background="subtle">
            ![Productions quote](/assets/images/productions/productions-quote.png)
        </Frame>

        **Note:** You may see an error message that there is no capacity available for the language you're interested in. If this happens, please check back later! Productions is a new service, and we will be adding capacity as quickly as we can.

    </Step>
    <Step title="Complete checkout">
      After reviewing the final quote, click 'Checkout' and follow the dialog instructions to complete your payment in Stripe.

      **Note:** enterprise orders are deducted from workspace credits instead of going through Stripe. If you have any questions or run into access issues, please contact your workspace admin or reach out to as productions@elevenlabs.io.
    </Step>
...
<AccordionGroup>
  <Accordion title="How much does it cost?">
    All Productions prices are presented to you USD ($) per minute of source audio. Exact prices depend on the type of asset you want to order (transcript, subtitles, dub, etc.), the source and target languages, and any custom style guide options you choose.
  ...
  <Accordion title="Can I make changes once I receive the final version?">
    For now, no. You can export a completed Production and make changes off platform. We plan to add support for this soon.
  ...
  <Accordion title="I have specific requirements I'd like to discuss – is that possible?">
    Yes! We'd love to hear from you at productions@elevenlabs.io.
  </Accordion>
</AccordionGroup>
