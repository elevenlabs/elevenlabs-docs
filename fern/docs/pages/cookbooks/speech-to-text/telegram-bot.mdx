...
subtitle: Build a Telegram bot that transcribes audio and video messages in 80+ languages using TypeScript with Deno in Supabase Edge Functions.
---

## Introduction

In this tutorial you will learn how to build a Telegram bot that transcribes audio and video messages in 80+ languages using TypeScript and the ElevenLabs Scribe model via the speech-to-text API.
