...
A big part of building conversational AI agents is allowing the agent accesss and execute functionality dynamically. This can be done via [client tools](https://elevenlabs.io/docs/conversational-ai/customization/tools-events/client-tools).
