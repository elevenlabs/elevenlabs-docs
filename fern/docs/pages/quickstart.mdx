...
<Card title="Cookbooks" href="/docs/cookbooks/text-to-speech">
...
>
  Deploy conversational voice agents in minutes
</Card>
...
<Card title="Voice changer (Speech-to-speech)" href="/docs/capabilities/voice-changer">
  Transform audio between voices
</Card>

<Card title="Voice isolator" href="/docs/capabilities/voice-isolator">
  Isolate speech from background noise
</Card>

<Card title="Dubbing" href="/docs/capabilities/dubbing">
  Dub videos in 32 languages
</Card>

<Card title="Text-to-voice" href="/docs/capabilities/voices#text-to-voice">
  Create voices from a single text prompt
</Card>

<Card title="Sound effects" href="/docs/capabilities/sound-effects">
  Create sound effects from text
</Card>

<Card title="Voices" href="/docs/capabilities/voices">
  Clone & design life-like voices
</Card>
...
>
  View the full REST API reference for ElevenLabs
</Card>
