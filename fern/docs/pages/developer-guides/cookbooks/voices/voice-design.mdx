...
<Steps>
    ...
    <Step title="Make the API request">
        ...
        voices = elevenlabs.text_to_voice.design(
            ...
            # Optional: reference_audio_base64 to provide reference audio to help the model design the voice. Only compatible with the eleven_ttv_v3 model.
        )
        ...
        const { previews } = await elevenlabs.textToVoice.design({
            ...
            text: "Greetings little human. I am a mighty giant from a far away land. Would you like me to tell you a story?",
            // Optional: referenceAudioBase64 to provide reference audio to help the model design the voice. Only compatible with the eleven_ttv_v3 model.
        });
