...
<CodeBlocks>
    ...
    print(track_details.composition_plan)

    # track_details.audio_base64 contains the audio as a base64 string
    ```
    ...
    console.log(JSON.stringify(trackDetails.compositionPlan, null, 2));

    // trackDetails.audioBase64 contains the audio as a base64 string
    ```
...
Explore the [API reference](/docs/api-reference/music/compose) for more information on the Speech to Text API and its options.
