...
<AccordionGroup>
  <Accordion title="Select by Requirements">
    <CardGroup cols={1}>
      <Card title="Quality">
  ...
  <Accordion title="Select by Use Case">
    <CardGroup cols={1}>
      ...
      <Card title="Conversational AI">
        Use either `eleven_flash_v2_5` or `eleven_flash_v2`
...
Multilingual v2 & Speech-to-Speech v2 models support 29 languages:
