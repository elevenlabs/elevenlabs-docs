...
<AccordionGroup>
  <Accordion title="Text normalization with numbers">
    ...
    When using the API you can mitigate this by using the `apply_text_normalization` [parameter](/api-reference/text-to-speech/convert#request.body.apply_text_normalization).
  </Accordion>
</AccordionGroup>
