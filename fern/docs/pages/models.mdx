...
<AccordionGroup>
  <Accordion title="Text normalization with numbers">
    ...
    For Conversational AI applications, best practice is to have your LLM [normalize the text](/docs/best-practices/prompting/normalization) before passing it to the TTS model.
