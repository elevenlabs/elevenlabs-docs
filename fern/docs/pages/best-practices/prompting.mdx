...
For more advanced control over pronunciation, explore [Pronunciation Dictionaries](https://elevenlabs.io/docs/product-guides/products/studio#pronunciation-dictionaries) to customize word pronunciations.
