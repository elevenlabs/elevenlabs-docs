---
title: Prompting ElevenLabs v3
subtitle: Learn how to use directional prompts and audio tags with our most advanced model.
---

<Info>
  ElevenLabs v3 introduces steerable AI voice generation through prompt tags. This guide covers the
  most effective techniques and tags for controlling voice delivery, emotion, and style.
</Info>

ElevenLabs v3 represents a breakthrough in AI voice technology. Unlike previous models, v3 is steerable—capable of interpreting directional prompts through audio tags. This makes prompting more important than ever for achieving precise, expressive results.

This guide provides the most effective tags and techniques for prompting v3, including emotional control, sound effects, and multi-speaker dialogue. Experiment with these methods to discover what works best for your specific voice and use case.
...
<Frame background="subtle">
  ![Stability settings in ElevenLabs
...
- **Robust** Highly stable—less responsive to directional prompts but consistent, similar to v2
...
Keep the quality slider at 100 for maximum clarity. This setting affects only audio fidelity, not delivery style or prosody.

## Audio Tags

v3 introduces emotional control through audio tags. You can direct voices to laugh, whisper, act sarcastic, or express curiosity among many other styles.
...
<AccordionGroup>
  <Accordion title="Emotionally Diverse">
    For expressive IVC or PVC voices, vary emotional tones across the recording—include both neutral
    and dynamic samples.
  </Accordion>
...
<Info>
  Professional Voice Cloning (PVC) support for v3 is coming soon. The same recording principles will
  apply.
</Info>
...
<Tabs>
  <Tab title="Dialogue Showcase">
    ...
    ```text
    Speaker 1: [excitedly] Sam! Have you tried the new ElevenLabs V3?
