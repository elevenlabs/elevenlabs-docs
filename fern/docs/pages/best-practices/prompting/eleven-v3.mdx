...
This guide provides the most effective tags and techniques for prompting Eleven v3, including changes in capitalization, punctuation, audio tags and multi-speaker dialogue. Experiment with these methods to discover what works best for your specific voice and use case.
...
<Info>
  ...
  apply. For now PVCs are handled as IVCs.
</Info>
