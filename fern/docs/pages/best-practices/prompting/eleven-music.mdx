...
- For vocals, use "acapella" before the vocal description (e.g., "acapella female vocals," "acapella male chorus").

To improve stem quality and control:

- Include key, tempo (BPM), and musical tone (e.g., "acapella vocals in A major, 90 BPM, soulful and raw").
