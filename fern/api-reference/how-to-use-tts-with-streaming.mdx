...
subtitle: How to convert text into speech, upload to S3, and share with a signed URL
slug: api-reference/how-to-use-tts-with-streaming
---
...
def text_to_speech_file(text: str) -> str:
    ...
    response = client.text_to_speech.convert(
        ...
        text=text,
        model_id="eleven_flash_v2_5", # use the Flash model for low latency, for other languages use the `eleven_multilingual_v2`
...
<Frame caption="AWS Console Login">
  <img src="./images/aws_console_login.png" />
</Frame>
...
<Frame caption="AWS IAM Dashboard">
  <img src="./images/aws_iam_dashboard.png" />
</Frame>
...
<Frame caption="Add AWS IAM User">
  <img src="./images/aws_iam_add_user.png" />
</Frame>
...
<Frame caption="Set Permission for AWS IAM User">
  <img src="./images/aws_iam_set_permission.png" />
</Frame>
...
<Frame caption="AWS Access Secret Key">
  <img src="./images/aws_access_secret_key.png" />
</Frame>

6. Get AWS region name: ex. us-east-1

<Frame caption="AWS Region Name">
  <img src="./images/aws_region_name.png" />
</Frame>
...
<Frame caption="Enter a New S3 Bucket Name">
  <img src="./images/aws_s3_enter_bucket_name.png" />
</Frame>

<Frame caption="S3 Bucket List">
  <img src="./images/aws_s3_bucket_list.png" />
</Frame>
