...
```sk_e1f4da359574b35b994242962a75a50d4656e7f426780021

### Making requests

You can paste the command below into your terminal to run your first API request. Make sure to replace `sk_e1f4da359574b35b994242962a75a50d4656e7f426780021` with your secret API key.

```bash
curl 'https://api.elevenlabs.io/v1/models' \
  -H 'Content-Type: application/json' \
  -H 'xi-api-key: $ELEVENLABS_API_KEY'sk_e1f4da359574b35b994242962a75a50d4656e7f426780021
```
