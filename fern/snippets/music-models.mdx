<CardGroup cols={1} rows={1}>
  <Card title="Eleven Music" href="/docs/models#eleven-music">
    ...
    <div className="mt-4 space-y-2">
      ...
      <div className="text-sm">Multilingual, including English, Spanish, German, Japanese and more</div>
      <div className="text-sm">Edit the sound and lyrics of individual sections or the whole song</div>
    </div>
  </Card>
</CardGroup>
