...
1. **In Genesys flow**: Define input session variables in your "Call Bot" action
...
<AccordionGroup>
  ...
  <Accordion title="Session variables not working">
    Verify that input session variables are properly defined in your Genesys flow's "Call Bot" action and that they're referenced correctly in your ElevenLabs agent using the {{variable_name}} syntax.
  </Accordion>
</AccordionGroup>
