...
<Step title="Configure a data collection items">
  In your ElevenLabs agent, add data collection item with a detailed identifier and description to collect where the user should be transferred to.
