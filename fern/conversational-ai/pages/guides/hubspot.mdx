...
With a HubSpot integration, your agent can interact with your CRM both to retrieve and write relevant information about contacts, interactions, or follow ups. 
...
<Frame background="subtle" caption="HubSpot Integration Demo">
  <iframe
    src="https://www.loom.com/share/cfb64cb7fc2a406489ef96e7c47d14c0?sid=cfb53cfb-724c-499d-8e92-92868b1f2ed9"
    frameBorder="0"
...
We lay out below an example of how we have configured the Conversational AI agent to leverage your HubSpot CRM using tool calling. 
...
1. **Create the secret value** by adding "Bearer " prefix:
   ...
   ```
   Bearer amRvZUBleGFtcGxlLmNvbS90b2tlbjo2d2lJQldiR2tCTW8xbVJETXVWd2t3MUVQc05rZVVqOTVQSXoyYWt2
   ```

4. **Save this as a secret** in your agent's secrets with name `hubspot_key`
