...
To enable chat mode at runtime using SDK overrides (rather than configuring the agent), you can use the `textOnly` override in your conversation configuration:
