...
4. **Create Authentication Secret**:
   ...
   - Example: `Bearer 00D5g000004PZoH!AQEAQIQEUqKKOYTsoK01jQx79...`
...
1. **Test Search Tool**:
   ```bash
   curl -X GET "https://your-domain.my.salesforce.com/services/data/v58.0/query/?q=SELECT%20Id%2C%20Name%2C%20Email%20FROM%20Contact%20LIMIT%205" \
...
- ✅ **Search Records**: Can find existing contacts/leads using SOQL
- ✅ **Get Record**: Can retrieve detailed record information
