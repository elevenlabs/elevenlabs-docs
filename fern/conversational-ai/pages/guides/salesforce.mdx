...
<Warning>
  ...
  **Workplace Auth Connections**: Configure the connection in your ElevenLabs dashboard and
  reference it in your webhook tool configurations' **Authentication** section, Replace
  `YOUR_SALESFORCE_SECRET` with your actual secret ID in the tool configurations.
</Warning>
