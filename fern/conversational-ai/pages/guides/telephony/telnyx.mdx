...
3. **Signaling and Media**: The initial call setup (signaling) uses TCP. Once the call is established, the actual audio data (RTP stream) is transmitted over UDP.
...
## Setting up Telnyx SIP trunking with ElevenLabs

- [Learn about creating conversational AI agents](/docs/conversational-ai/quickstart)
- [General SIP trunking information](/conversational-ai/guides/sip-trunking)
...
<Steps>
    ...
    <Step title="Navigate to SIP Trunking">
      Go to Voice » SIP Trunking in the Telnyx portal.
    </Step>
