...
<Note>
  Other client event types are not supported in the Genesys integration and should not be configured
  in your agent.
</Note>
...
<Accordion title="Audio quality issues">
  Ensure both user audio and output audio are set to μ-law 8kHz in your ElevenLabs agent
  configuration. Other audio formats may cause compatibility issues.
</Accordion>
