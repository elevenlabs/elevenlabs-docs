...
- **IP allowlisting**: Consider configuring IP restrictions in your Zadarma account for additional security
...
- [Set up call analytics and monitoring](/docs/conversational-ai/analytics)