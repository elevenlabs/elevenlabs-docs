...
5. **Audio codec compatibility**: Your system must support **48kHz audio output** or be capable of resampling audio to handle ElevenLabs' audio format
...
- **Audio format**: ElevenLabs outputs audio at **48kHz sample rate**. Your SIP trunk system must either support this format natively or perform resampling to match your system's requirements
