...
<AccordionGroup>
  ...
  <Accordion title="Connection Issues">
    ...
    **Important Network Architecture Information:**
    ...
    - Our SIP servers currently don't have static IP addresses to allow for dynamic scaling, so it's not possible to whitelist inbound communication on your side
