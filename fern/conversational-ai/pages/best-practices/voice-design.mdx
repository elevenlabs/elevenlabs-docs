...
<Frame background="subtle">
  ![Voice settings](/assets/images/conversational-ai/prompting-guide-voice-selection.png)
</Frame>
...
- **Similarity:** Higher values will boost the overall clarity and consistency of the voice. Very high values may lead to artifacts. Adjusting this value to find the right balance is recommended.

- **Speed:** Most natural conversations occur at 0.9-1.1× speed. Depending on the voice, adjust slower for complex topics or faster for routine information.
