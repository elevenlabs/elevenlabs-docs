...
<Note>
  Widgets currently require public agents with authentication disabled. Enable this in the
  **Advanced** tab of your agent settings.
</Note>
...
<Note>
  ...
  SDKs](/docs/conversational-ai/libraries) with a framework like Next.js, React, or Python.
</Note>
...
```javascript title="Client tools (Plain javascript)"
