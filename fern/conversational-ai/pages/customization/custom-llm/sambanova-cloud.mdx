...
For up-to-date information on context windows, please refer to [this](https://docs.sambanova.ai/cloud/docs/get-started/supported-models) page.
...
<Steps>
  ...
  <Step>
    Create a new [AI Agent](https://elevenlabs.io/app/conversational-ai/agents) or edit and existing one.
  </Step>
  <Step>  
  ...
  <Step>
   Save your changes and click on "Test AI Agent" to chat with your SambaNova model!
  </Step>
</Steps>
