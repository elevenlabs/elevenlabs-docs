...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="shield-check"
    href="/docs/conversational-ai/customization/privacy/zrm"
  >
...
For detailed instructions, see our [Zero Retention Mode](/docs/conversational-ai/customization/privacy/zrm) page.
