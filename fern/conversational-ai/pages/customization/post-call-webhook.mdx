...
You can secure your webhook endpoint using either OAuth 2.0 or HMAC authentication:

<Tabs>
  <Tab title="OAuth 2.0">
    <Frame background="subtle">
      ![OAuth 2.0 webhook configuration](/assets/images/conversational-ai/oauth2webhook.png)
    </Frame>
    Configure OAuth 2.0 authentication by providing: 
    - Client ID 
    - Client Secret 
    - Token URL 
    - Scope
  ...
  <Tab title="HMAC">
    ...
    - Verifying webhook signatures in your endpoint
  </Tab>
</Tabs>
