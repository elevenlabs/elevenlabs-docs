...
<Frame background="subtle">![Overview](/assets/images/conversational-ai/mcp-overview.png)</Frame>
...
<Frame background="subtle">
  ![Fine-grained tool approval settings](/assets/images/conversational-ai/mcp-finegrained-approvals.png)
</Frame>
