...
<Tabs>
  <Tab title="Bring your own OpenAI key">
    <Steps>
      <Step>
        In your agent settings, navigate to the **Secrets** section and click **Add Secret**.
      </Step>
      <Step>Choose "Custom LLM" from the dropdown menu</Step>
      <Step>Enter the URL, your model, and the secret you created</Step>
      <Step>Set "Custom LLM extra body" to true</Step>
    </Steps>
  </Tab>
  <Tab title="Custom LLM server"></Tab>
</Tabs>

This guide covers:

- Storing your OpenAI API key in ElevenLabs
- Hosting a server that replicates OpenAI's [create chat completion](https://platform.openai.com/docs/api-reference/chat/create) endpoint
- Directing ElevenLabs to your custom endpoint
- Passing extra parameters to your LLM as needed
...
<Steps>
  <Step>
    ...
    {/* # TODO:  replace image../developer-guides/images/byollm_1.webp" /> */}
  </Step>
  <Step>
    Choose "Custom LLM" from the dropdown menu.
    {/* # TODO:  replace image../developer-guides/images/byollm_2.webp" /> */}
  </Step>
  <Step>
    Enter the URL, your model, and the secret you created.
    {/* # TODO:  replace image../developer-guides/images/byollm_3.webp" /> */}
  </Step>
  <Step>
    Set "Custom LLM extra body" to true.
    {/* # TODO:  replace image../developer-guides/images/byollm_7.webp" /> */}
  </Step>
</Steps>
...
{/* # TODO:  replace image../developer-guides/images/byollm_4.webp" /> */}
...
{/* # TODO:  replace image../developer-guides/images/byollm_5.webp" /> */}

### Configuring Elevenlabs CustomLLM

Now let's make the changes in Elevenlabs

{/* # TODO:  replace image../developer-guides/images/byollm_6.webp" /> */}
