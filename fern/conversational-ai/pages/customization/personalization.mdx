...
```json
{
  ...
  "conversation_config_override": {
    "agent": {
      ...
      "first_message": "string", // Initial message
    ...
    "custom_llm_extra_body": {
      ...
      "max_tokens": 100 // Max tokens in responses
    }
  },
  "dynamic_variables": {
...
<Table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        - Inserting user-specific data into templated content 
        - Maintaining consistent agent behavior with personalized details 
        - Personalizing tool parameters
      </td>
    ...
    <tr>
      <td>**Overrides**</td>
      <td>
        - Completely changing agent behavior per user 
        - Switching languages or voices 
        - Legacy applications (consider migrating to Dynamic Variables)
      </td>
      <td>
...
- [Dynamic Variables Documentation](/docs/conversational-ai/customization/dynamic-variables)
- [Overrides Documentation](/docs/conversational-ai/customization/overrides)
- [Twilio Integration Documentation](/docs/conversational-ai/customization/dynamic-variables/twilio-inbound-integration)
