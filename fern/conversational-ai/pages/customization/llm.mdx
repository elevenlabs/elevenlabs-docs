  ...
  <Accordion title="Gemini">
    ...
    <Tabs>
      ...
      <Tab title="Per minute cost estimation">
        ...
        | ----------------------- | ----------------------------- | ------------------------------- |
        | `gemini-1.5-pro`        | 0.01                            | 0.10                            |
        | `gemini-1.5-flash`      | 0.004                           | 0.01                            |
        | `gemini-2.0-flash`      | 0.002                           | 0.02                            |
        | `gemini-2.0-flash-lite` | 0.001                           | 0.009                           |
        | `gemini-2.5-flash`      | 0.004                           | 0.10                            |
  ...
  <Accordion title="OpenAI">
    ...
    <Tabs>
      ...
      <Tab  title="Per minute cost estimation">
        ...
        | `gpt-4o`        | 0.02                            | 0.13                            |
        | `gpt-4`         | n/a                             | n/a                             |
        | `gpt-4-turbo`   | 0.08                            | 0.39                            |
        | `gpt-4.1`       | 0.02                            | 0.13                            |
        | `gpt-4.1-mini`  | 0.004                           | 0.07                            |
        | `gpt-4.1-nano`  | 0.0009                          | 0.006                           |
  ...
  <Accordion title="Anthropic">
    Anthropic's Claude models are designed with a focus on helpfulness, honesty, and harmlessness, often featuring large context windows.
      ...
      <Tab title="Per minute cost estimation">
          ...
          | Model                  | Avg LLM Cost (No KB) ($/min)    | Avg LLM Cost (Large KB) ($/min) |
          | ---------------------- | -----------------------------   | ------------------------------- |
          | `claude-3-7-sonnet`    | 0.06                            | 0.26                            |
          | `claude-3-5-sonnet`    | 0.06                            | 0.20                            |
          | `claude-3-5-sonnet-v1` | 0.04                            | 0.17                            |
          | `claude-3-0-haiku`     | 0.005                           | 0.03                            |
