...
<AccordionGroup>
  <Accordion title="Gemini">
    ...
    | Model                   | Max Output Tokens | Max Context (Tokens) | Input Price ($/1M tokens) | Output Price ($/1M tokens) | Input Cache Read ($/1M tokens) | Input Cache Write ($/1M tokens) | Avg LLM Cost (No KB) ($/min) | Avg LLM Cost (Large KB) ($/min) |
    | ----------------------- | ----------------- | -------------------- | ------------------------- | -------------------------- | ------------------------------ | ------------------------------- | ----------------------------- | ------------------------------- |
    | `gemini-1.5-pro`        | 8,192             | 2,097,152            | 1.25                      | 5                          | 0.3125                         | n/a                             | 0.01                            | 0.10                            |
    | `gemini-1.5-flash`      | 8,192             | 1,048,576            | 0.075                     | 0.3                        | 0.01875                        | n/a                             | 0.004                           | 0.01                            |
    | `gemini-2.0-flash`      | 8,192             | 1,048,576            | 0.1                       | 0.4                        | 0.025                          | n/a                             | 0.002                           | 0.02                            |
    | `gemini-2.0-flash-lite` | 8,192             | 1,048,576            | 0.075                     | 0.3                        | n/a                            | n/a                             | 0.001                           | 0.009                           |
    | `gemini-2.5-flash`      | 65,535            | 1,048,576            | 0.15                      | 0.6                        | n/a                            | n/a                             | 0.004                           | 0.10                            |
  ...
  <Accordion title="OpenAI">
    ...
    | Model           | Max Output Tokens | Max Context (Tokens) | Input Price ($/1M tokens) | Output Price ($/1M tokens) | Input Cache Read ($/1M tokens) | Input Cache Write ($/1M tokens) | Avg LLM Cost (No KB) ($/min) | Avg LLM Cost (Large KB) ($/min) |
    | --------------- | ----------------- | -------------------- | ------------------------- | -------------------------- | ------------------------------ | ------------------------------- | ----------------------------- | ------------------------------- |
    | `gpt-4o-mini`   | 16,384            | 128,000              | 0.15                      | 0.6                        | 0.075                          | n/a                             | 0.003                           | 0.10                            |
    | `gpt-4o`        | 4,096             | 128,000              | 2.5                       | 10                         | 1.25                           | n/a                             | 0.02                            | 0.13                            |
    | `gpt-4`         | 8,192             | 8,192                | 30                        | 60                         | n/a                            | n/a                             | n/a                             | n/a                             |
    | `gpt-4-turbo`   | 4,096             | 128,000              | 10                        | 30                         | n/a                            | n/a                             | 0.08                            | 0.39                            |
    | `gpt-4.1`       | 32,768            | 1,047,576            | 2                         | 8                          | n/a                            | n/a                             | 0.02                            | 0.13                            |
    | `gpt-4.1-mini`  | 32,768            | 1,047,576            | 0.4                       | 1.6                        | 0.1                            | n/a                             | 0.004                           | 0.07                            |
    | `gpt-4.1-nano`  | 32,768            | 1,047,576            | 0.1                       | 0.4                        | 0.025                          | n/a                             | 0.0009                          | 0.006                           |
    | `gpt-3.5-turbo` | 4,096             | 16,385               | 0.5                       | 1.5                        | n/a                            | n/a                             | 0.02                            | 0.08                            |
  ...
  <Accordion title="Anthropic">
    ...
    | Model                  | Max Output Tokens | Max Context (Tokens) | Input Price ($/1M tokens) | Output Price ($/1M tokens) | Input Cache Read ($/1M tokens) | Input Cache Write ($/1M tokens) | Avg LLM Cost (No KB) ($/min) | Avg LLM Cost (Large KB) ($/min) |
    | ---------------------- | ----------------- | -------------------- | ------------------------- | -------------------------- | ------------------------------ | ------------------------------- | ----------------------------- | ------------------------------- |
    | `claude-3-7-sonnet`    | 4,096             | 200,000              | 3                         | 15                         | 0.3                            | 3.75                            | 0.06                            | 0.26                            |
    | `claude-3-5-sonnet`    | 4,096             | 200,000              | 3                         | 15                         | 0.3                            | 3.75                            | 0.06                            | 0.20                            |
    | `claude-3-5-sonnet-v1` | 4,096             | 200,000              | 3                         | 15                         | 0.3                            | 3.75                            | 0.04                            | 0.17                            |
    | `claude-3-0-haiku`     | 4,096             | 200,000              | 0.25                      | 1.25                       | 0.03                           | 0.3                             | 0.005                           | 0.03                            |
...
Certain LLMs available on our platform may be suitable for use in environments requiring HIPAA compliance, please see the [HIPAA compliance docs](/docs/conversational-ai/customization/hipaa-compliance) for more details
