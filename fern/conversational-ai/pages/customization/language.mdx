...
<Note>
  Adding any additional language automatically upgrades the agent to use our v2.5 Multilingual
  model.
</Note>
...
<Note>
  ...
  support 32 languages. Collectively, these languages are spoken by approximately 90% of the world's
  population.
</Note>
...
[Dynamic Conversation](/docs/conversational-ai/customization/dynamic-conversation) guide for implementation details.
