...
<Note>
  To find a great voices for each language curated by the ElevenLabs team, visit the language top
  picks [section](https://elevenlabs.io/app/voice-library/collections).
</Note>
