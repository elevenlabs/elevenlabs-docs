...
Add the [language detection tool](/docs/conversational-ai/customization/tools-events/system-tools/language-detection) to your agent can automatically switch to the user's preferred language.
