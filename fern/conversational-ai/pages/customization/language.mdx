...
You can specify which language to use for the widget by setting the `language` attribute.

```html title="Widget"
<elevenlabs-convai language="es"></elevenlabs-convai>
```

Pass in this parameter dynamically to integrate the widget with your internationalization framework.
