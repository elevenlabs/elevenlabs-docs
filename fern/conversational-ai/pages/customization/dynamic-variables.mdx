...
- `system_agent_id` - Unique identifier of the agent (does not update after agent-agent transfers)
- `system_current_agent_id` - Unique identifier of the currently active agent (updates after agent-agent transfers)
