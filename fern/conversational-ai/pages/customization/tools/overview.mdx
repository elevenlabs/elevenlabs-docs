...
<Steps>
  <Step title="Configure the weather tool">
    First, head to the **Tools** section of your dashboard and choose **Add Tool**. Select **Webhook** as the Tool Type, then configure the weather API integration:
  ...
  <Step title="Orchestration">
    ...
    <Success>
      ...
      handle both specific locations ("What's the weather in Tokyo?") and general queries ("How's
