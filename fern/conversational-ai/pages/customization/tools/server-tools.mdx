...
<Tab title="Supported Authentication Methods">

Conversational AI supports multiple authentication methods to securely connect your tools with external APIs:
...
Simple username and password authentication for APIs that support HTTP Basic Auth. Set up by clicking **Add Auth** on **Workspace Auth Connections** in the **agent page**.
