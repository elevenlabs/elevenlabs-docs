...
<Check>
  **June 30, 2024** - Last day for full backwards compatibility. You can continue using
  `prompt.tools` until this date.
</Check>

<Note>
  **July 1, 2024** - GET endpoints will stop returning the `tools` field. Only `prompt.tool_ids`
  will be included in responses.
</Note>

<Warning>
  **July 16, 2024** - Legacy `prompt.tools` field will be permanently removed. All requests
