...
You can specify a minimum delay before the transfer occurs. This is useful for:
- Providing a brief pause for natural conversation flow
- Allowing the current agent to finish speaking before transferring
- Creating a more seamless handoff experience

### Transfer Message

An optional custom message can be played during the transfer. This allows you to:
- Inform the user about the transfer
- Set expectations about what the new agent will help with
- Provide a professional transition experience

### Transferred Agent First Message

Control whether the transferred agent should automatically play its configured first message after the transfer. This setting helps:
- Avoid redundant greetings when the transfer message already sets context
- Maintain conversation continuity
- Customize the user experience based on transfer scenarios
