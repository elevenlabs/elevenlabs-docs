...
- **Automated systems interaction**: Navigate phone menus, enter extensions, input codes
- **Contextual usage**: LLM determines when and what tones to play based on conversation context
...
<CardGroup cols={2}>
  <Card title="Phone menu navigation" icon="list">
    Navigate automated phone systems by pressing menu options (e.g., "Press 1 for sales, 2 for
    support")
  </Card>
  <Card title="Extension dialing" icon="phone">
    Enter phone extensions when prompted by company phone systems
  </Card>
  <Card title="PIN/Code entry" icon="key">
    Input security codes, account numbers, or verification PINs
  </Card>
  <Card title="Multi-step sequences" icon="steps">
    Execute complex sequences with pauses for systems that require specific timing
  </Card>
</CardGroup>
...
# - dtmf_tones: The sequence of tones to play (e.g., "123*456#" or "1w2W3")
# - reason: Optional explanation for why the tones are being played
```
