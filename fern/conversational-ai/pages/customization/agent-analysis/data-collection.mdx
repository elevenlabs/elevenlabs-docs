...
<Info>
  Extracted data is available through [Post-call Webhooks](/docs/conversational-ai/workflows/post-call-webhook) for integration with CRM systems, databases, and analytics platforms.
</Info>