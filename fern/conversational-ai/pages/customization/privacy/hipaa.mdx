...
<Warning>
  ...
  documents uploaded by an agent owner to the [Knowledge base](https://elevenlabs.io/docs/conversational-ai/customization/knowledge-base) aren't covered and should not include
  PHI.
</Warning>
...
<Note>
  HIPAA compliance is only available on Enterprise tier subscriptions and requires a BAA to be
  in place between you and ElevenLabs. Contact your account representative to discuss enabling this feature for your
  organization.
</Note>
...
<Steps>
  ...
  >
    ![Redacted conversation analysis showing HIPAA compliance in action](/assets/images/conversational-ai/hipaa-model.png)
  </Frame>
