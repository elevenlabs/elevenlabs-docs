...
<Note>
  If you need to use LLMs that aren't pre-configured in ZDR mode (e.g., OpenAI's GPT-4o mini), you can still do so by:
  1. Obtaining a BAA directly from the provider
  2. Using their API key with our Custom LLM integration
</Note>
