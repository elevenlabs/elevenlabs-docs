...
subtitle: Configure dynamic variables for incoming Twilio calls using webhooks.
---
...
<Steps>
  ...
  <Step title="Return conversation initiation client data">
   Your webhook must return a JSON response containing the dynamic variables specified by the agent. For example:
