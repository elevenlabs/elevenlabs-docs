...
<CardGroup cols={1}>
  <Card title="Customer service" horizontal="true">
    Assistants trained on company documentation that can handle customer queries, troubleshoot
    issues, and provide 24/7 support in multiple languages.
  </Card>
  <Card title="Virtual assistants" horizontal="true">
    Assistants traned to manage scheduling, set reminders, look up information, and help users stay
    organized throughout their day.
  </Card>
  <Card title="Retail support" horizontal="true">
    Assistants that help customers find products, provide personalized recommendations, track
    orders, and answer product-specific questions.
  </Card>
  <Card title="Personalized learning" horizontal="true">
    Assistants that help students learn new topics & enhance reading comprehension by speaking with
    books and [articles](https://elevenlabs.io/blog/time-brings-conversational-ai-to-journalism).
  </Card>
</CardGroup>
