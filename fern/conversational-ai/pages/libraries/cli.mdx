...
<Frame background="subtle">
  <Card title="Get Started" icon="github">
    [View the complete source code and contribute on GitHub
    →](https://github.com/elevenlabs/packages/tree/main/packages/convai-cli)
  </Card>
</Frame>
...
- **Multi-tenant voice agents**: Deploy different agent configurations for each client or environment with a single command
- **Integration-ready bots**: Connect to your existing APIs, databases, and tools through webhook and client-side integrations
- **Embeddable widgets**: Generate HTML embed codes for seamless web integration across multiple sites
