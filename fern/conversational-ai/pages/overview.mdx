...
<Note>
  ...
  in Conversational AI to maintain compliance with EU data residency. Custom LLMs and OpenAI remain
  available. For more infomation please see [GDPR and data
