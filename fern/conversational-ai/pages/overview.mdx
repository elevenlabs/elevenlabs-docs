...
In multimodal text + voice mode, text message pricing per message (LLM costs are passed through separately):
...
<Note>
  Today we're covering the LLM costs, though these will be passed through to customers starting June
  21, 2025.
</Note>
...
- **Multi-character storytelling**: Interactive narratives with distinct voices for different characters, powered by our new [multi-voice support](/docs/conversational-ai/customization/voice/multi-voice) feature.
