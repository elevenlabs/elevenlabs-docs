---
title: Quickstart
subtitle: Build your first conversational AI voice agent.
---
...
<Note>
  The web dashboard uses our [Web
  SDK](https://elevenlabs.io/docs/conversational-ai/libraries/conversational-ai-sdk-react) under the
  hood to handle real-time conversations.
</Note>

## Overview

In this guide, we'll create an AI assistant for Pierogi Palace, a Polish restaurant that takes voice orders for traditional dishes, addressing their challenge of managing high call volumes.

<Frame
  caption="The Pierogi Palace menu showcases traditional Polish dishes that customers can order through the AI assistant"
  background="subtle"
>
  ![Pierogi Palace](/assets/images/conversational-ai-quickstart-pierogi-palace.jpg)
</Frame>
