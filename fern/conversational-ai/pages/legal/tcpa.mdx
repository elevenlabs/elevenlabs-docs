...
subtitle: Learn how ElevenLabs Conversational AI supports TCPA compliance
---

<Note>
  Visit our [Compliance Portal](https://elevenlabs.io/compliance) for comprehensive information on
  our certifications and practices.
</Note>

This guide outlines essential consent requirements under the Telephone Consumer Protection Act (TCPA) for developers and businesses using ElevenLabs Conversational AI for outbound calls in the United States. Adherence to the TCPA is critical when using AI-generated voices for outbound communications.
...
| :------------------------------------- | :--------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Marketing Call**                     | **Prior Express Written Consent (PEWC)** | 1. A **signed written agreement** from the recipient (electronic signatures under E-SIGN Act are valid).<br /><br />2. The agreement must feature a **clear and conspicuous disclosure** stating that:<br />&nbsp;&nbsp;&nbsp;&nbsp; (A) The recipient authorizes _[Your Company Name]_ to make calls using an artificial/prerecorded voice to the specific phone number provided; **AND**<br />&nbsp;&nbsp;&nbsp;&nbsp; (B) Consent is **not** consent towards purchasing any goods or services. | "By checking this box and providing my phone number, I agree to receive marketing calls from _[Your Company Name]_, including using an AI-generated voice, at the number provided." |
| **Non-Marketing / Informational Call** | **Prior Express Consent (PEC)**          | The consumer must have given permission to be contacted at the number provided for informational purposes (e.g., providing a phone number for appointment reminders or account updates). While not always requiring a written agreement like PEWC, consent must still be express and affirmative.                                                                                                                                                                                                 | "Please provide your phone number if you'd like to receive [e.g., appointment reminders, service updates] from _[Your Company Name]_, including via an AI-generated voice."         |
...
2.  **Consent Revocation**: Consumers can revoke consent at any time through "any reasonable manner" (e.g., verbal request during a call, email, text reply like "STOP").
    ...
    - Honor revocations promptly, generally within 10 business days.
...
If your call includes promotional content, it will likely be classified as marketing, requiring PEWC.

<Warning title="Legal Disclaimer">
  This guide is for informational purposes only and does not constitute legal advice. The TCPA is
  complex and subject to interpretation. Consult with qualified legal counsel to ensure your
  specific use of ElevenLabs Conversational AI for outbound calling complies with all applicable
