...
<AccordionGroup>
  ...
  <Accordion title="Do I need to change my API calls or SDK usage?">
    Yes, the API base URL will change to `https://api.eu.residency.elevenlabs.io` and you will need to use API keys
    associated with your European data residency account. For the SDK, you can change the base URL by changing
    the environment parameter when you initialize the client. Other than that, the API functionality remains consistent.
  </Accordion>
</AccordionGroup>
