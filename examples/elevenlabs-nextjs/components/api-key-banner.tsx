      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            {hasApiKey ? (
              <>
                <span className="flex items-center gap-2">
                  ...
                  <span>
                    {variant === "sidebar" ? "API Key Set" : "API Key Set"}
                  </span>
                </span>
                {variant === "sidebar" && (
              ...
              <>
                <span className="flex items-center gap-2">
                  <AlertTriangleIcon
                    className={cn("h-4 w-4", !hasApiKey && "animate-pulse")}
                  />
                  <span>
                    {variant === "sidebar" ? "Set API Key" : "Set API Key"}
                  </span>
                </span>
                {variant === "sidebar" && (
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Enter your ElevenLabs API key to access the platform features. You
              can find your API key in your{" "}
              <Link
