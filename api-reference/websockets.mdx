...
More practical guides on using the Websockets API are provided below:

<CardGroup>
    <Card
        title="Chatbot with Live Highlighting"
        icon="robot"
        href="/guides/websockets-highlight-chatbot"
    >
        Creating a chatbot with live text highlighting using ElevenLabs Websockets API.
    </Card>
    <Card
        title="Example Guide"
        icon="terminal"
