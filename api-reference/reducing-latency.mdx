...
Based on our testing, we've observed that default voices (formerly premade voices), synthetic voices, and Instant Voice Clones tend to have lower latency compared to Professional Voice Clones. A Professional Voice Clone allows for a much more accurate clone of the original samples, albeit with a slight increase in latency at present. Unfortunately, it is a slight tradeoff and we're currently working on optimizing PVC latency for Turbo v2.5.
