...
## 2. Use the [streaming API](streaming)
...
## 3. Use the [input streaming Websocket](websockets)
...
## 6. Use Premade, Synthetic Voices & IVCs rather than PVCs
From our testing, we've seen premade/deafult, synthetic voices & IVCs show lower latency than PVCs. We're currently working to optimize PVC latency for Turbo v2.5. If you'd like to use your PVC with Turbo v2.5, you can fine tune it by heading to the "My Voices" tab of [Voice Lab](https://elevenlabs.io/app/voice-lab), selecting your voice, and choosing "+ Eleven Turbo v2.5" to initiate fine tuning - but note that you may see higher latency than Premade, Synthetic Voices & IVCs. 
