...
<Info>
  Pronunciation dictionaries only work with the models `eleven_turbo_v2` and
  `eleven_monolingual_v1`. If you use pronunciation dictionaries with other
  models, they will silently skip the word.
</Info>
