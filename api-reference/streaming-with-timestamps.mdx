...
Stream audio with character-level timing information, which allows you to synchronize text with audio playback. This is useful for applications like karaoke, subtitles, or word-by-word highlighting. Here's how to use it:
