---
title: "How to use text to sound effects"
description: "Learn how to use the text to sound effects API to generate sound effects from text."
icon: "volume"
---
...
<Tip>
  ...
  docs](/sound-effects/overview). And for information on the API configuration
  visit [the API reference](/api-reference/text-to-sound-effects).
</Tip>
...
We're excited to see what you build with the API. Here's some ideas of what you might want to use it for:
