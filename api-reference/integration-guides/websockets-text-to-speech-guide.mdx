---
title: ' Integrate Text-to-Speech WebSockets for Apps and Chatbots'
...
- WebSockets generally has lower latency but discontinuous timecodes, although some buffering is needed.
- Streaming has higher latency but you get back a continuous audio stream.
...
For more detailed documentation, please visit the [text-to-speech websockets docs](https://docs.elevenlabs.io/api-reference/text-to-speech-websockets)
