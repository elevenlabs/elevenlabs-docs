...
2. Configure whitelisted sites - these are the list of website domains that will be permitted to play your content. Your Audio Native players will only work on sites that begin with the domains that you specify in this list.
    - Click on Add URL 
    <img height="200" src="audio-native/images/an_url_allowlist_empty_state.png" />
    -  If "elevenlabs.io/" is whitelisted, then the Audio Native player will work on any site on the elevenlabs website. 
    <img height="200" src="audio-native/images/an_url_elevenlabs.png" />
    ...
    <img height="200" src="audio-native/images/an_url_elevenlabs_blog.png" />
    If you try to embed audio native on pages that don't follow that path, you'll see this message:
    <img height="200" src="audio-native/images/an_url_not_allowed.png" />
4. Configure your Audio Native player’s appearance and default settings.
    ...
    <img height="200" src="audio-native/images/an_voice_wrong_model.png" />
    ...
    - By default, our embedded widget will create a voice over of all of the text content on your page. You can customize the content we target with CSS selectors.
5. Now that you've finished customizing your player, head back to the General tab and grab your embed code.
    ...
    <img height="200" src="audio-native/images/an_embed_code.png" />
