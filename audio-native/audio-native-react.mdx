...
Here’s a guide on how you can use [Audio Native](/audio-native/overview) in your React projects. I’ll be using Next.js, but this process will work for any React project.
...
<iframe width="100%" height="90" frameBorder="no" scrolling="no" seamless src="https://elevenlabs.io/player/index.html?publicUserId=4d7f6f3d38ae27705f5b516ffd3e413a09baa48667073d385e5be1be773eaf69&projectId=vXhjY1vtXDZ5EdXH0CRg&small=true&textColor=rgba(0,%200,%200,%201)&backgroundColor=rgba(255,%20255,%20255,%201)"></iframe>
...
<img height="200" src="/audio-native/images/an-1.png" />
...
<img height="200" src="/audio-native/images/an-2.png" />
...
<img height="200" src="/audio-native/images/an-3.png" />
...
If you have any further questions, or suggestions on how to improve this blog post, please feel free to message me on Twitter/X [@marcelthomas5](https://twitter.com/marcelthomas5).
