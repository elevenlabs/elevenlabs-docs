...
Now that you've created & customized your Audio Native player, navigate to Framer. Go to Site Settings in Framer and add the script tag from the ElevenLabs Embed Code to the section called: End of body tag.

<img height="200" src="/audio-native/images/framer_an_1.png" />

Now on your Framer blog page, add an Embed Element from Utilities. 

<img height="200" src="/audio-native/images/framer_an_2.png" />

In the config for the Embed Element, switch the type to HTML and the <div> snippet from the ElevenLabs Embed Code.

<img height="200" src="/audio-native/images/framer_an_3.png" />
...
<img height="200" src="/audio-native/images/framer_an_4.png" />
