...
Now that you've created & customized your Audio Native widget, navigate to Framer. Go to Site Settings in Framer and add the script tag from the ElevenLabs Embed Code to the section called: End of body tag.
