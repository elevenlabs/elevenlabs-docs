...
and you'd need to use below information from ElevenLabs:
...
Steps:
- Register an SAML application with your identity provider; Fill in required fields (SP entity id, redirect URL).
