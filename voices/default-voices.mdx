...
Unlike voices you add from the Voice Library or new <a href="/voices/voice-lab/instant-voice-cloning">Instant Voice Clones (IVCs)</a> or <a href="/voices/voice-lab/professional-voice-cloning">Professional Voice Clones (PVCs)</a> you create, default voices are not accessed via your <a href="/voices/voice-lab/overview">My Voices</a>.
