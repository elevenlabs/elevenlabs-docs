...
Unlike voices you add from the Voice Library or new <a href="docs/voices/voice-lab/instant-voice-cloning">Instant Voice Clones (IVCs)</a> or <a href="docs/voices/voice-lab/professional-voice-cloning">Professional Voice Clones (PVCs)</a> you create, default voices are not accessed via your <a href="docs/voices/voice-lab/overview">VoiceLab</a>.
