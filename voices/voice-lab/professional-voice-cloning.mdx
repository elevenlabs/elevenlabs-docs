...
<Info>The video is currently slightly outdated as we've released new features since it was made, and the training time is significantly quicker. However, a lot of the information in it is still relevant.</Info>

<iframe width="100%" height="400" src="https://www.youtube.com/embed/bY9DO6wa_vs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
- [Audiobook](/voices/voice-lab/scripts/the-great-gatsby)
- [News Article](/voices/voice-lab/scripts/news-article)
- [Social Media](/voices/voice-lab/scripts/social-media) 
- [Meditation](/voices/voice-lab/scripts/meditation)
- [Elearning](/voices/voice-lab/scripts/elearning)
