...
<img height="200" src="/documentation/voices/voice-library/images/library.png" />
...
>
  Generated voices made using **[Voice Design](/documentation/voices/voice-lab/voice-design)**
</Card>
<Card
...
>
  ...
  Cloning](/documentation/voices/voice-lab/professional-voice-cloning)**
</Card>
<Card
  title="HQ"
>
  The HQ label stands for High Quality, and indicates that this Professional Voice Clone has been trained on audio which follows our **[Professional
  Recording Guidelines](/documentation/voices/voice-lab/professional-voice-cloning)** and 
  has passed a quality control check on input texts of various lengths.
</Card>

### Sharing Options

Other labels tell you about options the voice owner set when sharing the voice. Please see the **[Sharing](/documentation/voices/voice-library/sharing)** page for more details.
