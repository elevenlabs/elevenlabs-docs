...
**1. Share Button:** To get started with sharing a voice model, find the voice model you want to share in <a href="voices/voice-lab/overview">My Voices</a> and click the share icon:
