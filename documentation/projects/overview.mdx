...
<iframe width="100%" height="400" src="https://www.youtube.com/embed/A8pCRjne3hc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
Click “Create new project” and you will be presented with a popup. Here, you can choose to create a new empty project, import an already existing EPUB, PDF, or TXT file, which will then automatically be converted into a project, or import text directly from a website using the URL to have the page be converted into a project. You can then use our [Audio Native](/documentation/audio-native/overview) feature to easily and effortlessly embed any narration project onto your website.

<img height="200" src="/documentation/projects/images/projects_new.png" />
...
<img height="200" src="/documentation/projects/images/projects_settings.png" />
...
<img height="200" src="/documentation/projects/images/project_quality_updated.png" />
...
<img height="200" src="/documentation/projects/images/projects_overview.png" />
...
<img height="200" src="/documentation/projects/images/projects_convert.png" />
...
Once your Project is converted, you have several download options available. By pressing the large "Download" button, only the active Chapter open in your Project will be downloaded. By clicking the dropdown button, you will see more options available such as "Project Download" which will combine every Chapter in your Project into one audio file. "Zip Download" is a helpful new option which will download your full Project and seperate each Chapter into its own audio file. 

<img height="200" src="/documentation/projects/images/projects_zip_dropdown.png" />
