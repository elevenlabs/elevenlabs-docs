...
<img height="150" src="/documentation/workspace/images/identity_providers.png" />
...
<img height="150" src="/documentation/workspace/images/verify_domain_button.png" />

- Enter the domain name you want to verify.

<img height="150" src="/documentation/workspace/images/domain_verification.png" />
...
<img height="150" src="/documentation/workspace/images/dns_records.png" />
...
<img height="150" src="/documentation/workspace/images/sso_oidc.png" />
- Click on `Add Domain` Button and choose the domain you want to enable SSO for from the list of verified domains.
<img height="50" src="/documentation/workspace/images/add_domains.png" />
...
<img height="150" src="/documentation/workspace/images/sso_saml.png" />
- Click on `Add Domain` Button and choose the domain you want to enable SSO for from the list of verified domains.
- Click on the `Update SSO` button.
