...
Here's a guide on how you can use [Audio Native](/documentation/audio-native/overview) in your React projects. I'll be using Next.js, but this process will work for any React project.
...
<img
  height="200"
  src="/documentation/audio-native/images/an_url_not_allowed.png"
/>
