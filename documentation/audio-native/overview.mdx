...
2. Configure whitelisted sites - these are the list of website domains that will be permitted to play your content. Your Audio Native players will only work on sites that begin with the domains that you specify in this list.
    - Click on Add URL 
    <img height="200" src="/documentation/audio-native/images/an_url_allowlist_empty_state.png" />
    -  If "elevenlabs.io/" is whitelisted, then the Audio Native player will work on any site on the elevenlabs website. 
    <img height="200" src="/documentation/audio-native/images/an_url_elevenlabs.png" />
    ...
    <img height="200" src="/documentation/audio-native/images/an_url_elevenlabs_blog.png" />
    ...
    <img height="200" src="/documentation/audio-native/images/an_url_not_allowed.png" />You can resolve this by checking that the URL for the page is added to your URL list correctly.  
3. Configure your Audio Native player’s appearance and default settings.
    ...
    <img height="200" src="/documentation/audio-native/images/an_voice_wrong_model.png" />
...
4. Now that you've finished customizing your player, head back to the General tab and grab your embed code.
    ...
    <img height="200" src="/documentation/audio-native/images/an_embed_code.png" />
...
<video
  controls
  className="w-full"
  src="/documentation/projects/videos/Manual_Audio_Native.mp4"
></video>
...
<img height="200" src="/documentation/projects/images/an8.png" />
