...
Click “Create new project” and you will be presented with a popup. Here, you can choose to create a new empty project, import an already existing EPUB, PDF, or TXT file, which will then automatically be converted into a project, or import text directly from a website using the URL to have the page be converted into a project. You can then use our [Audio Native](/projects/audio-native) feature to easily and effortlessly embed any narration project onto your website.
